        ...
        return this.trace(SpanKind.CONSUMER, 'process', this.name, async (span) => {
            ...
            try {
                ...
                if (unrecoverableErrorMessage) {
                    const failed = await this.retryIfFailed(() => this.handleFailed(new UnrecoverableError(unrecoverableErrorMessage), job, token, fetchNextCallback, span), { delayInMs: this.opts.runRetryDelay, span });
                    return failed;
                }
